...
$title = "Tambah User  - SMKIT IBNUL QAYYIM";
...
if ($msg == 'notimage') {
  $alert = '<div class="alert alert-warning alert-dismissible fade show" role="alert">
  <i class="fa-solid fa-xmark"></i> Tambah user gagal, file yang and upload bukan gambar..
<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>';
}
      ...
      <form action="proses-user.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="card">
          <div class="card-header">
            <span class="h-5 my-2"><i class="fa-solid fa-square-plus"></i> Tambah User</span>
            ...
            <div class="row">
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-9" style="margin-left:-50px;">
                    <select name="jabatan" id="jabatan" class="form-select border-0 border-bottom" required>
                      ...
                      <option value="Guru" selected>Guru mata pelajara</option>
                    </select>
                  </div>
                </div>
                <div class="mb-3 row">
              ...
              <div class="col-4 text-center px-5">
                ...
                <small class="text-secondary">
                  pilih foto PNG,JPG atau JPEG dengan ukuran maximal 1 MB
                </small>
