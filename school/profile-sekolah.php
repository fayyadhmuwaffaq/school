...
$title = "Profile Sekolah - SMKIT IBNUL QAYYIM";
            ...
            <form action="proses-sekolah.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-header">
                        <span class="h-5"><i class="fa-solid fa-pen-to-square"></i>Data Sekolah</span>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-4 text-center px-5">
                                ...
                                <img src="../asset/image/<?= $data['gambar'] ?>" alt="gambar sekolah" class="m-2" width="440px" height="260px">
