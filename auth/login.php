...
$sekolah = mysqi_query($koneksi, "SELECT * FROM tbl_sekolah WHERE id = 1")
...
<html lang="en">
    <head>
        ...
        <title>Login - SMKIT IBNUL QAYYIM</title>
        ...
        <style>
            #bglogin{
                background-image: url("../asset/iamge/<?= $data['gambar']?>");
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h4 class="text-center font-weight-light my-4">Login - SMKIT IBNUL QAYYIM</h4></div>
                                    <div class="card-body">
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="text-muted small">Copyright &copy; SMKIT IBNUL QAYYIM <?= date("Y") ?> </div>
                                    </div>
                                </div>
                            </div>
                        </div>
